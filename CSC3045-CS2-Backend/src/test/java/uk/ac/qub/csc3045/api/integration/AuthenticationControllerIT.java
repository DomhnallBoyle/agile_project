...
public class AuthenticationControllerIT {
    ...
    public static final String TEST_CONTEXT = "/project/team";
    public static final String TEST_CONTEXT2 = "/project/teamGet";
    ...
    public void test() {
        ...
        User user = new User("ab", "xy", "abcasdffasdgahdef@gmail.com");
        User user2 = new User("ba", "yx", "abcdesdfaf@gmail.com");
        User user3 = new User("hgh", "fhf", "abcdsfef@gmail.com");
        ...
        assertEquals(project, r.getBody().as(Project.class));
    ...
    //
    // @Test
    // public void registerAccountAsProductOwnerRoleShouldReturn200() throws
    // Exception{
    // validAccount.setUsername(generateUsername());
    ...
    //
    // @Test
    // public void registerAccountAsScrumMasterRoleShouldReturn200() throws
    // Exception{
    // validAccount.setUsername(generateUsername());
    ...
    //
    // @Test
    // public void registerAccountwithMulipleRolesShouldReturn200() throws
    // Exception{
    // validAccount.setUsername(generateUsername());
    // validRole.setProductOwner(true);
    // validRole.setScrumMaster(true);
    ...
    //
    // @Test
    // public void multipleInvalidDetailsShouldReturn400WithMultipleErrors() throws
    // Exception {
    // Account invalidAccount = validAccount;
    // invalidAccount.setPassword("a");
    // invalidAccount.getUser().setEmail("wrong");
